...
@section('name', 'Workshop Attendance')
        ...
        function startScanner() {
            ...
            html5QrCode.start({
                ...
                (decodedText) => {
                    ...
                    var route = `/admin/attendance/workshop/${id}`;
                    route = route.replace(/\/$/, '');
                    ...
                    fetch(route + '/' + decodedText, {
                        ...
                        .then(data => {
                            ...
                            window.location.href = `/admin/attendance/workshop/${id}`; // or wherever you want
                            alert(data.message);
                        })
                        .catch(error => {
                            // handle error
