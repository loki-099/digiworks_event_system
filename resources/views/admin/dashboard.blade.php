            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="/admin/dashboard" class="flex ms-2 md:me-24">
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Admin Dashboard</span>
                    </a>
                </div>
    ...
    <div class="p-4 sm:ml-64 min-h-screen dark:bg-gray-950">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div
                ...
                <p class="text-white text-2xl font-bold absolute left-3 bottom-3">Cotabato DigiWork Expo 2026</p>
            </div>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                <div class="flex flex-col justify-between dark:text-white p-2 h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
                    <h2 class="text-xl">Attending:</h2>
                    <p class="text-2xl font-bold text-yellow-400">{{ $attendeesCount }}</p>
                </div>
                <div class="flex flex-col justify-between dark:text-white p-2 h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
