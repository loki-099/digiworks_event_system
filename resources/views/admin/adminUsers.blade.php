    ...
    <div class="p-4 sm:ml-64 min-h-screen dark:bg-gray-950">
        <div class="p-4 mt-14">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach ($registrations as $registration)
                            <tr
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" type="button" data-modal-target="edit-registration-modal-{{ $registration->id }}"
                                data-modal-toggle="edit-registration-modal-{{ $registration->id }}">
            ...
            @forelse($registrations as $registration)
                    <div id="edit-registration-modal-{{ $registration->id }}" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                    ...
                                    <button type="button"
                                        ...
                                        data-modal-hide="edit-registration-modal-{{ $registration->id }}">
                                ...
                                <div class="p-6 space-y-6">
                                    <form id="update-registration-form-{{ $registration->id }}" class="space-y-4"
                                        action="{{ route('updateAttendee', $registration->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to update {{ $registration->attendee->name ?? 'this attendee' }}?');"> 
                                        @csrf
                                        @method('PUT')
                                        <div>
                                            <label for="edit_attendee_name_{{ $registration->id }}"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Name</label>
                                            <input type="text" name="name" id="edit_attendee_name_{{ $registration->id }}"
                                                placeholder="attendee name" value="{{ $registration->attendee->name }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                        </div>

                                        <div>
                                            <label for="edit_attendee_email_{{ $registration->id }}"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Email</label>
                                            <input type="text" name="email"
                                                id="edit_attendee_email_{{ $registration->id }}" placeholder="Attendee email"
                                                value="{{ $registration->attendee->email }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                        </div>

                                        <div>
                                            <label for="edit_attendee_affiliation_{{ $registration->id }}"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Affiliation/School</label>
                                            <input type="text" name="affiliation"
                                                id="edit_attendee_affiliation_{{ $registration->id }}" placeholder="Affiliation"
                                                value="{{ $registration->attendee->affiliation }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between pt-4 border-t dark:border-gray-600">
                                        <div class="flex items-center space-x-2">
                                            <button data-modal-hide="edit-registration-modal-{{ $registration->id }}" type="button"
                                            ...
                                            <button form="update-registration-form-{{ $registration->id }}" type="submit"
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <form action="{{ route('admin.user.delete', ['id' => $registration->attendee_id]) }}" method="POST"
